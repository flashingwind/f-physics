...
表と1枚目を比較すると、干潮・満潮はそもそも極大・極小であって(最大・最小ではないので)、天体の運動と比較するには向かないことが分かる。
...
> Munk と Cartwright (1966)《※》 によって応答法と呼ばれる新しい解析・予報方式も提案されている．この方法は，天体の起潮力を入力，潮汐現象を出力とするダイナミカルシステムとして潮汐現象を解析するものである．応答法は，調和法に比べ計算が複雑なため，実用的には，まだまだ調和法が広く用いられている

という記述がある(《※》引用者注：W. H. Munk, D. E. Cartwright, _Tidal Spectroscopy and Prediction,_ Phil. Trans. R. Soc. A, 259(1105), 1966, p. 533-81.のこと)。
...
- W. H. Munk, D. E. Cartwright, _Tidal Spectroscopy and Prediction,_ Phil. Trans. R. Soc. A, 259(1105), 1966.
